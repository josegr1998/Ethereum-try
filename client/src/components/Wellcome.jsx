...
const Wellcome = () => {
  const connectWallet = useContext(TransactionContext).connectWallet;
  const { formData, setFormData, handleChange, sendTransaction } =
    useContext(TransactionContext);

  const currentAccount = useContext(TransactionContext).currentAccount;
    ...
    <div className='flex w-full justify-center items-center gradient-bg-services'>
      <div className='flex md:flex-row flex-col items-start justify-between md:p-20 py-12 px-4'>
        <div className='flex flex-1 justify-start flex-col md:mr-10'>
          ...
          my-5 bg-[#2952e3] p-3 cursor-pointer rounded-full hover:bg-[#2546bd]
          '
            >
          ...
          <div className='p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism'>
            ...
            {false ? (
              ...
              <button
                ...
                className='text-white w-full mt-2 border-[1px] p-2 border-[#ed4f7c] rounder-full cursor-pointer'
              >
                Send Now
              </button>
            )}
